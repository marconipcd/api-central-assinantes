...
public class PlanoAcesso {
	...
	@Column(name="PLANO_RENOVACAO", nullable=true)
	private Integer plano_Renovacao;
	@Column(name="SERVICO_PLANO_ID")
	private Integer servico_plano;
	...
	@Column(name = "CATEGORIA_SITE")
	private String categoria_site;
	
	@Column(name = "EXIBIR_SITE")
	private String exibir_site;
	...
	public Integer getServico_plano() {
		return servico_plano;
	}

	public void setServico_plano(Integer servico_plano) {
		this.servico_plano = servico_plano;
	}

	public Integer getPlano_Renovacao() {
		return plano_Renovacao;
	}

	public void setPlano_Renovacao(Integer plano_Renovacao) {
		this.plano_Renovacao = plano_Renovacao;
	}

	public String getExibir_site() {
		return exibir_site;
	}

	public void setExibir_site(String exibir_site) {
		this.exibir_site = exibir_site;
	}

	public String getCategoria_site() {
		return categoria_site;
	}

	public void setCategoria_site(String categoria_site) {
		this.categoria_site = categoria_site;
	}
