...
public class Cliente {
    ...
    @Column(name="INDICADO_POR", nullable=true)
    private Integer indicado_por;
...
//    private List<ContasReceber> contas_receber;
	...
	public Cliente(Integer id, String doc_cpf_cnpj,
			...
			String celular1, String celular2, String email, String msn,
			 String obs, String forma_pgto_padrao,
	...
	public Integer getIndicado_por() {
		return indicado_por;
	}
	public void setIndicador_por(Integer indicado_por) {
